...
const LogoComponent = () => {
  ...
  return (
    <div className="flex items-center gap-x-2 p-2">
      <div className="grid h-10 w-10 -rotate-6 grid-cols-3 grid-rows-3 gap-1 rounded bg-blue-700 p-1 shadow-xl md:h-12 md:w-12 dark:bg-blue-500">
...
const TokenLogoComponent = ({ color }: { color: ColorToken }) => {
  const colorClass = {
    R: "bg-red-500 dark:bg-yellow-300",
